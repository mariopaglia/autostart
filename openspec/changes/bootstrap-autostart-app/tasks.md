...
<!-- 2.3 e 2.5–2.9: código implementado, testes e CI ok. Falta a verificação manual (monitor com TextEdit no macOS e UI) e o checkpoint 2.10 no Windows com o build de preview. -->
